...
const Manor1: Task[] = [
	...
	},
	{
		...
		prepare: () => {
			if (!have($item`government-issued eyeshade`))
		...
		outfit: () => {
			return {
				equip: have($item`government-issued eyeshade`)
					? $items`government-issued eyeshade, June cleaver`
					: $items`June cleaver`,
				modifier: "-combat",
			};
		},
...
const Manor2: Task[] = [
	...
	},
	{
		...
		after: ["Start Floor2"],
		completed: () =>
			$location`The Haunted Gallery`.turnsSpent >= 5 || step("questM21Dance") >= 2,
	...
	},
	{
		...
		after: ["Gallery Delay"],
		completed: () =>
			have($item`Lady Spookyraven's dancing shoes`) || step("questM21Dance") >= 2,
		do: $location`The Haunted Gallery`,
		choices: { 89: 6, 896: 1 }, // TODO: louvre
	...
	},
	{
		...
		after: ["Start Floor2"],
		completed: () =>
			$location`The Haunted Bathroom`.turnsSpent >= 5 || step("questM21Dance") >= 2,
...
const ManorBasement: Task[] = [
	{
		...
		completed: () =>
			$location`The Haunted Ballroom`.turnsSpent >= 5 || step("questL11Manor") >= 1,
		do: $location`The Haunted Ballroom`,
